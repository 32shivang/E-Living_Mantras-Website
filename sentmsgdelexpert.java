...
/**
 * Servlet implementation class sentmsgdelexpert
 */
@WebServlet("/sentmsgdelexpert")
public class sentmsgdelexpert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(flag==0) {
				...
				response.sendRedirect("/E-Living_Mantras/Dietician/expertsentitems.jsp");
			}
				...
				RequestDispatcher rd=request.getRequestDispatcher("/Dietician/expertsentitems.jsp"); 
