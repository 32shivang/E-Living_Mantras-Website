...
<li style="list-style-type: none;  width:100%; "><a href="/E-Living_Mantras/Dietician/expertsentitems.jsp" style="color:blue;">Sent Items</a></li>
</ul>
</div>
<br>
<div style="border-bottom:1px solid #979A9A; width:100%">
...
<%
   click = Integer.parseInt(request.getParameter("start"));
	String s="select count(*) from sentitem where Senderid=?";
   ...
   String strsql="select * from sentitem where Senderid=?";
	...
	if(i==count){
	 ...
	 String str="select Message from sentitem where Senderid=? and Msgid=? ";
		//we have to send it to a java file
