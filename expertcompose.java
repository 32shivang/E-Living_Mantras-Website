...
/**
 * Servlet implementation class expertcompose
 */
@WebServlet("/expertcompose")
public class expertcompose extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(rw>0 && row1>0) {
				...
				RequestDispatcher rd=request.getRequestDispatcher("/Dietician/expertcompose.jsp"); 
