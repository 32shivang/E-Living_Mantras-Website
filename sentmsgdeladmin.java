...
/**
 * Servlet implementation class sentmsgdeladmin
 */
@WebServlet("/sentmsgdeladmin")
public class sentmsgdeladmin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(flag==0) {
				...
				response.sendRedirect("/E-Living_Mantras/Admin/adminsentitems.jsp");
			}
				...
				RequestDispatcher rd=request.getRequestDispatcher("/Admin/adminsentitems.jsp"); 
