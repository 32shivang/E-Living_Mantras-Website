...
<li style="list-style-type: none;  width:100%; "><a href="/E-Living_Mantras/Admin/admininbox.jsp" style="color:blue">Inbox</a></li>
</ul>
</div>
<br>
<div style="border-bottom:1px solid #979A9A; width:100%">
...
<%if(info!=null){
  ...
  <strong>No!</strong> Record To Delete
  		...
  		<%} %>
<form method="post" action="/E-Living_Mantras/msgdeleteadmin">
...
function al(){
	...
	$("#myTable tr").click(function() {
		 ...
		 document.location.href ="/E-Living_Mantras/Admin/showmessage.jsp?start="+row;
	    });
	});
