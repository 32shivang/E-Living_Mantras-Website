...
<li style="list-style-type: none;  width:100%; "><a href="/E-Living_Mantras/Dietician/expertcompose.jsp"style="color:blue;">Compose</a></li>
</ul>
</div>
<br>
<div style="border-bottom:1px solid #979A9A; width:100%">
...
<%if(info!=null){
  ...
  <strong>ID!</strong> Not Exists
  		...
  		<%} %>
<form action="/E-Living_Mantras/expertcompose" method="post"id="right">
