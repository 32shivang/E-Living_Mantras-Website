...
/**
 * Servlet implementation class msgdeleteexpert
 */
@WebServlet("/msgdeleteexpert")
public class msgdeleteexpert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(flag==0) {
				...
				response.sendRedirect("/E-Living_Mantras/Dietician/expertinbox.jsp");
			}
				...
				RequestDispatcher rd=request.getRequestDispatcher("/Dietician/expertinbox.jsp"); 
